...
public class UsuarioService {
    ...
    // Método para obtener el teléfono a partir del email
    public String getPhoneByEmail(String email) {
        // Busca al usuario por su email usando el método del repositorio
        Usuario usuario = usuarioRepository.findByEmail(email)
                .orElseThrow(() -> new RuntimeException("Usuario no encontrado con el email: " + email));
        
        // Devuelve el número de teléfono del usuario encontrado
